...
// const api: string = "https://green-shop-backend.onrender.com/api";
...
// function MainMapping(): JSX.Element {
//   const [activeType, setActiveType] = useState<string | null>(null);
//   const [searchParams, setSearchParams] = useSearchParams();
//   const category: string = searchParams.get("category") || "house-plants";
//   const sort: string = searchParams.get("sort") || "default-sorting";
//   const type: string = searchParams.get("type") || "all-plants";
//   const range_min: number = Number(searchParams.get("range_min")) || 0;
//   const range_max: number = Number(searchParams.get("range_max")) || 1000;

//   const { data, isLoading, error } = useQuery<FlowerResponse>({
